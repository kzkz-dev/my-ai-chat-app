...
# ==========================================
# 🔹 Flux AI (Cyberpunk Glass - Build 19.0.0) 💎
# ==========================================
APP_NAME = "Flux AI"
OWNER_NAME = "KAWCHUR"
...
def home():
    ...
    <head>
        ...
        <style>
            :root {{
                /* 🌌 CYBERPUNK PALETTE */
                --bg-gradient: radial-gradient(circle at 10% 20%, rgb(15, 15, 30) 0%, rgb(5, 5, 10) 90%);
                --sidebar-glass: rgba(20, 20, 35, 0.65);
                --header-glass: rgba(20, 20, 35, 0.8);
                --input-glass: rgba(30, 30, 50, 0.7);
                ...
                --bot-gradient: linear-gradient(135deg, #00f3ff 0%, #bc13fe 100%);
                --user-gradient: linear-gradient(135deg, #2b32b2 0%, #1488cc 100%);
                
                --danger: #ff0f7b;
                --success: #00ff87;
                
                --shadow-neon: 0 0 10px rgba(0, 243, 255, 0.2), 0 0 20px rgba(188, 19, 254, 0.1);
            }}
            ...
            * {{ box-sizing: border-box; outline: none; -webkit-tap-highlight-color: transparent; }}
            ...
            #sidebar.glass {{ backdrop-filter: blur(20px); }}
            ...
            .brand i {{ 
                background: var(--bot-gradient); -webkit-background-clip: text; color: transparent; 
                filter: drop-shadow(0 0 5px rgba(188, 19, 254, 0.6));
            }}
            ...
            .about-link:hover {{ color: var(--accent); text-shadow: 0 0 10px var(--accent); }}
            ...
            /* 🌟 WELCOME SCREEN - ANIMATED & GLOWING 🌟 */
            .welcome-container {{
            ...
            .icon-wrapper {{ 
                ...
                margin-bottom: 25px; 
                box-shadow: 0 0 30px rgba(0, 243, 255, 0.15), inset 0 0 20px rgba(255, 255, 255, 0.05);
                animation: levitate 4s ease-in-out infinite;
                position: relative;
            }}
            .icon-wrapper::after {{
                content: ''; position: absolute; inset: -2px; border-radius: 30px; 
                background: var(--bot-gradient); z-index: -1; opacity: 0.4; filter: blur(10px);
            }}
            .icon-wrapper i {{ background: var(--bot-gradient); -webkit-background-clip: text; color: transparent; }}
            ...
            .bot-avatar {{ background: var(--bot-gradient); color: white; }}
            .user-avatar {{ background: rgba(255,255,255,0.1); color: white; border: 1px solid var(--border); }}
            ...
            .sender-name {{ font-size: 0.75rem; color: var(--text-secondary); margin-bottom: 5px; font-weight: 600; padding-left: 2px; text-transform: uppercase; letter-spacing: 0.5px; }}
            ...
            .bubble strong {{ color: var(--accent); font-weight: 700; text-shadow: 0 0 10px rgba(0, 243, 255, 0.3); }}
            .bubble img {{ 
                max-width: 100%; border-radius: 18px; margin-top: 12px; cursor: pointer; 
                box-shadow: 0 8px 30px rgba(0,0,0,0.4); border: 1px solid var(--border); 
            ...
            .send-btn:hover {{ transform: scale(1.1); background: var(--accent); color: black; box-shadow: 0 0 20px var(--accent); }}
            ...
            .modal-box {{
                background: rgba(20, 20, 35, 0.85); border: 1px solid var(--border); 
            ...
            .btn-delete {{ background: var(--danger); color: white; box-shadow: 0 5px 20px rgba(255, 15, 123, 0.4); }}
            .btn-confirm {{ background: var(--success); color: black; box-shadow: 0 5px 20px rgba(0, 255, 135, 0.4); }}
            .btn-modal:hover {{ transform: translateY(-2px); filter: brightness(1.2); }}

            /* ADMIN PANEL */
            .stats-grid {{ display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 25px; }}
            .stat-box {{ background: rgba(255,255,255,0.05); padding: 15px; border-radius: 14px; border: 1px solid var(--border); }}
            .stat-val {{ font-size: 1.6rem; font-weight: 700; color: var(--accent); text-shadow: 0 0 10px rgba(0, 243, 255, 0.4); }}
            .stat-label {{ font-size: 0.8rem; color: var(--text-secondary); text-transform: uppercase; letter-spacing: 1px; margin-top: 5px; }}
            ...
            .dot {{ width: 8px; height: 8px; background: var(--accent); border-radius: 50%; animation: typingBounce 1.4s infinite ease-in-out both; box-shadow: 0 0 10px var(--accent); }}
    ...
    <body class="dark">
        ...
        <div id="admin-auth-modal" class="modal-overlay">
            <div class="modal-box">
                ...
                <input type="password" id="admin-pass" style="width:100%; padding:14px; border-radius:12px; border:1px solid var(--border); background:rgba(0,0,0,0.3); color:white; margin-bottom:10px; outline:none; font-size:1rem; text-align:center;" placeholder="••••••••">
                <div id="admin-error-msg" style="color:var(--danger); font-size:0.9rem; margin-bottom:20px; display:none; font-weight:600; text-shadow: 0 0 10px rgba(255, 15, 123, 0.4);"><i class="fas fa-exclamation-circle"></i> Invalid Password</div>
                <div style="display:flex;">
        ...
        <script>
            ...
            function confirmDelete() {{ localStorage.removeItem('flux_v19_history'); location.reload(); }}
