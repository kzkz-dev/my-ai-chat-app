        ...
        <div id="main">
            ...
            <div id="chat-box">
                <div id="welcome" class="welcome-container">
                    <div style="font-size:3.5rem; color:var(--accent); margin-bottom:20px;"><i class="fas fa-heart"></i></div>
                    <div style="font-size:2rem; font-weight:800; margin-bottom:10px;">Flux AI x Valentine</div>
                    <div style="color:gray;">Try: "Create a propose link for [Name]"</div>
        ...
        <script>
            ...
            async function sendMessage() {{
                ...
                try {{
                    ...
                    saveData();
                }} catch(e) {{ appendBubble("⚠️ Network Error: " + e, false); }}
            }}
...
def chat():
    try:
        ...
        Rules:
        1. If search results are provided, USE THEM to answer.
        2. If user asks for a 'love link' or 'propose link', guide them to ask: 'Create a propose link for [Name]'.
        """
        ...
        return jsonify({"reply": f"⚠️ **System Error:** {str(e)}", "searched": False})
